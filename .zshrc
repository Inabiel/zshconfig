...
alias rdc="redis-cli"
alias gpom="git pull origin main --no-ff"
alias gpod="git pull origin development --no-ff"
alias gcp="git cherry-pick"
alias cmpm="git checkout main && git pull origin main --no-ff"
alias grhs="go run main.go http serve"
